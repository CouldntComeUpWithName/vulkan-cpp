...
#define ASSERT(condition, message, ...) if(!(condition)) fmt::println("\033[31mASSERTION FAILED\033[0m: {}, {} (file: {}, line: {}, from: {})", #condition, fmt::format(message, __VA_ARGS__), filename(__FILE__), __LINE__, func_sig(std::source_location::current().function_name()))